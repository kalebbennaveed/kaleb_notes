...
The difference between the models is the choice of state \(x\), input \(u\), and dynamics \(f(x,u)\).

The single integrator directly controls velocity. The double integrator controls acceleration. The unicycle model includes heading. The 2D dynamic bicycle model includes vehicle slip and tire forces. The quadrotor model includes three-dimensional translation and rigid-body rotation.